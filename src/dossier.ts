...
const REVELATION_LAYERS: Record<string, RevelationLayer[]> = {
  '格雷格': [
    ...
    { trustRequired: 5, fact: '达里安日记中提到矿道最深处有一块"会唱歌的棱形石头"——他认为那就是虚空棱镜', category: '线索' },
  ],
  '小莉': [
    ...
    { trustRequired: 4, fact: '靠近晨光石碑时印记会微微发热，她觉得石碑在"叫她"', category: '线索' },
    { trustRequired: 5, fact: '曾在梦里看到矿道深处一块发紫光的棱形石头，醒来后鼻血不止', category: '线索' },
  ],
  '艾琳娜': [
    ...
    { trustRequired: 5, fact: '200年前她目睹虚空棱镜在另一座城市被激活，整座城在一夜间消失——她是唯一幸存者', category: '秘密' },
    { trustRequired: 5, fact: '她推算出教团每隔约200年尝试一次激活，这次的时间窗口就在最近几周内', category: '线索' },
  ],
  '维克多': [
    ...
    { trustRequired: 3, fact: '教团通过一只黑色乌鸦传递纸条给他指令，每次月圆前三天会来', category: '线索' },
    { trustRequired: 4, fact: '被暗影教团胁迫——他们绑架了索菲亚', category: '秘密' },
    { trustRequired: 4, fact: '教团要求他签署开放矿道深层的许可、压下失踪报告、并销毁石碑上的封印记载', category: '秘密' },
    { trustRequired: 4, fact: '最后一次收到的纸条上说：如果再有冒险者进入矿道中层，索菲亚会"回来一只手"', category: '秘密' },
    { trustRequired: 5, fact: '壁炉暗格里藏着被他删除的石碑封印记录', category: '秘密' },
    { trustRequired: 5, fact: '索菲亚失踪前曾告诉他在矿道入口看到"穿黑袍的人在画圈"——他当时没当回事', category: '秘密' },
  ],
  '卡恩': [
    ...
    { trustRequired: 3, fact: '对破晓镇的历史了如指掌，包括一些连本地人都不知道的细节——像是提前做过功课', category: '线索' },
    { trustRequired: 4, fact: '从不饮酒，只是假装抿一口——格雷格调的酒被他原封不动留在桌上', category: '线索' },
    { trustRequired: 4, fact: '琴箱有隐藏夹层，里面的东西散发微弱暗影能量', category: '秘密' },
    { trustRequired: 5, fact: '暗影教团高阶执行者，计划在仪式中篡夺虚空棱镜的力量', category: '秘密' },
    { trustRequired: 5, fact: '独自在月池旁练习过一段晦涩的咏唱——那是他私自修改过的棱镜激活咒文', category: '秘密' },
  ],
  '陈妈': [
    ...
    { trustRequired: 2, fact: '丈夫出事那天本不该下矿——是临时被叫去替班的，她一直觉得那次"矿难"不简单', category: '秘密' },
    { trustRequired: 3, fact: '最近注意到有些"陌生面孔"频繁出入镇外', category: '线索' },
    { trustRequired: 3, fact: '那些陌生人总在月圆前后出现，而且她注意到他们左手腕上都戴着一样的黑绳', category: '线索' },
    { trustRequired: 4, fact: '曾在夜里看到卡恩独自往暮色森林方向走', category: '线索' },
    { trustRequired: 4, fact: '去年镇长突然不来旅店了，之前他每周五都来喝一杯——她觉得镇长像是被什么东西吓住了', category: '关系' },
    { trustRequired: 5, fact: '有一次深夜失眠散步到矿道入口附近，看到地面上有一圈淡紫色的光在旋转，吓得跑回了旅店', category: '秘密' },
  ],
  '格罗姆': [
    ...
    { trustRequired: 2, fact: '黑色晶体靠近铁器时会发出微弱嗡鸣，像是某种共振——他从没在任何矿石上见过这种反应', category: '线索' },
  ...
  '叶绿': [
    ...
    { trustRequired: 2, fact: '近几周有好几个矿工来求诊，都说在矿道里听到低语声，回来后频繁做同样的噩梦——梦见一只巨大的眼睛', category: '线索' },
  ...
  '韩猛': [
    ...
    { trustRequired: 2, fact: '三支小队失联的模式一样：到矿道中层后联络中断，最后一条消息都提到"异常寒冷"', category: '线索' },
