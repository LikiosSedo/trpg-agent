  ...
  return [
    {
      ...
      knownFacts: [
        ...
        { text: '二十年前暮色森林里的蜘蛛可没这么大。一定有什么东西在喂养它们，让它们变异了。小心蛛母——它会吐丝缠住你，然后叫来小蜘蛛围攻', minChapter: 2 },
        { text: '去森林别带短剑，刺不穿大蜘蛛的壳。带把重武器或者火把，火是对付蜘蛛最好的办法', minChapter: 2 },
      ],
      playerPromises: [],
      interactionLog: [],
    ...
    },
    {
      ...
      knownFacts: [
        ...
        { text: '森林里...有一个很大很大的黑影。不是普通的蜘蛛，它身上缠着紫色的丝线，连着地底下什么东西', minChapter: 2 },
        { text: '矿道下面有一团...活着的黑暗。它不是鬼，是更可怕的东西。它在吃那些死去矿工的灵魂', minChapter: 3 },
        { text: '那个黑暗中的东西...它不是活着的，是虚空在呼吸。只有破晓的光能伤到它。我看到了...一把发光的锤子，和一个发光的精灵', minChapter: 4 },
      ],
      playerPromises: [],
      interactionLog: [],
      location: 'dawnbreak-town',
    ...
    },
    {
      ...
      knownFacts: [
        ...
        { text: '暗影编织者是虚空能量凝聚的产物，不是自然生物。它免疫一切暗蚀攻击，物理武器也很难伤到它。唯一的克星是光辉之力——银油、灵银武器、或者我的银光箭', minChapter: 3 },
        { text: '暗影编织者有自愈能力，每一刻都在吸收周围的黑暗修复自身。但如果用光辉攻击命中它，它的自愈会暂时中断。保持光辉压制是关键', minChapter: 3 },
        { text: '蚀日兽是虚空棱镜的守护者，是蚀目者教团仪式的最终产物。它的暗影护甲几乎刀枪不入，只有光辉力量能穿透。带上破晓战锤，带上我，我们一起去结束这一切', minChapter: 4 },
      ],
      playerPromises: [],
      interactionLog: [],
      location: 'dawnbreak-town',
    ...
    },
    {
      ...
      knownFacts: [
        ...
        { text: '矿道深处有不对劲的东西。上次派下去的矿工说他们的火把莫名其妙地灭了，黑暗中有东西在动。普通铁器砍上去像砍空气', minChapter: 3 },
        { text: '灵银是对付暗影的好材料。我锻造过灵银长剑，剑身会自己发光。如果你要去矿道深处，最好带一把', minChapter: 3 },
      ],
      playerPromises: [],
      interactionLog: [],
      location: 'dawnbreak-town',
    ...
    },
    {
      ...
      knownFacts: [
        ...
        { text: '最近森林深处的蜘蛛变得异常巨大，蛛丝都变成了不自然的暗紫色。普通武器的刺击几乎穿不透蛛母的甲壳，但火焰能烧穿它', minChapter: 2 },
        { text: '如果你要去对付蛛母，带些火焰油涂在武器上。我这里有卖。杀了蛛母后把毒腺带回来，我能用它调制出特殊的防护药水', minChapter: 2 },
      ],
      playerPromises: [],
      interactionLog: [],
      location: 'dawnbreak-town',
    ...
    },
    {
      ...
      knownFacts: [
        ...
        { text: '去森林的话多带几个人。蛛母不是一个人能对付的——它会吐丝困住你，然后一群小蜘蛛就冲上来了', minChapter: 2 },
        { text: '如果你真要去碎石荒原，别单独行动。最后派出去的侦察队五个人去了三个没回来。那东西比矿道里的暗影强十倍不止', minChapter: 4 },
      ],
      playerPromises: [],
      interactionLog: [],
      location: 'dawnbreak-town',
