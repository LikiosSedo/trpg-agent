...
export const CHAPTERS: ChapterDef[] = [
  ...
  // ═══════════════════════════════════════════════
  {
    ...
    dmSecrets: [
      ...
      '',
      '蛛母·织暗者是暮色森林的真正威胁。她的巢穴中弥漫的暗紫色蛛丝是虚空能量泄漏的征兆——这与矿道深处的教团活动有关，但玩家此时还不知道。战斗中要描写蛛丝的不自然颜色和蛛母的异常智慧。',
    ].join('\n'),
    ...
    beats: [
      ...
      },
      {
        ...
        facts: [
          '暮色森林深处的蛛母已被击败，不自然的暗紫色蛛丝开始枯萎。蛛母的异变似乎与地底的某种力量有关...',
  ...
  // ═══════════════════════════════════════════════
  {
    ...
    dmSecrets: [
      ...
      '',
      '暗影编织者守护着蚀目者教团的祭坛。击败它后，玩家会找到暗影核心——教团存在的铁证。描写暗影编织者时强调它不是自然生物，而是矿工怨灵和虚空能量的融合体。',
    ].join('\n'),
    ...
    beats: [
      ...
      },
      {
        ...
        facts: ['矿道深处祭坛前的暗影编织者被击败，它消散时留下了一颗凝实的暗影核心——这是教团进行虚空仪式的铁证'],
      },
      {
        id: 'ch3_cult_traces',
        trigger: 'auto',
        requires: ['ch3_enter_mines', 'ch3_shadow_boss'],
        facts: [
  ...
  // ═══════════════════════════════════════════════
  {
    ...
    dmSecrets: [
      ...
      '',
      '蚀日兽是虚空棱镜的最终守护者。这场战斗是整个冒险的高潮。描写蚀日兽时要营造绝望感——光线被吞噬、温度骤降、周围的石头开始腐蚀。但当玩家使用光辉武器命中时，描写光芒刺穿暗影的壮观场面。',
    ].join('\n'),
    ...
    beats: [
      ...
      {
        id: 'ch4_eclipsed_boss',
        trigger: 'combat_end',
        requires: ['ch4_tower_discovery'],
        facts: ['蚀日兽被击败，虚空棱镜的守护消散。通往棱镜的道路终于打开。这就是蚀目者教团的最终秘密——一个正在崩塌的远古封印'],
      },
      {
        id: 'ch4_wasteland_complete',
        trigger: 'talk:艾琳娜',
        requires: ['ch4_tower_discovery', 'ch4_eclipsed_boss'],
        facts: [
          '回到公会时，所有人都在等着听报告',
