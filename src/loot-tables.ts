...
export const LOOT_TABLES: LocationLootTable[] = [
  ...
  // ── 铁砧铺 ──────────────────────────────────────
  {
    ...
    items: [
      ...
      },
      {
        name: '短剑 +1',
        type: 'weapon',
        description: '精良短剑，轻便趁手。造成1d6+1穿刺伤害。',
        bonus: 1,
        probability: 0.5,
        quantity: [1, 1],
        condition: 'chapter>=2',
  ...
  // ── 暮色森林 ────────────────────────────────────
  {
    ...
    items: [
      ...
      },
      {
        name: '强化皮甲',
        type: 'armor',
        description: '由蜘蛛丝加固的皮甲，轻便而坚韧。AC+2，不影响灵活性。',
        bonus: 2,
        probability: 0.4,
        quantity: [1, 1],
        condition: 'chapter>=2',
      ...
      },
      {
        name: '火焰油',
        type: 'misc',
        description: '炎石粉和油脂混合的涂层。涂抹在武器上附加火焰伤害类型。',
        probability: 0.25,
        quantity: [1, 1],
        condition: 'chapter>=2',
        oneTime: false,
  ...
  // ── 灰脊矿道上层 ────────────────────────────────
  {
    ...
    items: [
      ...
      },
      {
        name: '银油',
        type: 'misc',
        description: '灵银粉末和月光草调制的涂层。武器附加光辉伤害类型。',
        probability: 0.20,
        quantity: [1, 1],
        condition: 'chapter>=3',
        oneTime: true,
  ...
  // ── 灰脊矿道中层（废弃兵营） ─────────────────────
  {
    ...
    items: [
      ...
      },
      {
        name: '灵银长剑',
        type: 'weapon',
        description: '矿道深处开采的灵银锻造，剑身泛着微光。造成1d8+1劈砍伤害，对亡灵额外有效。',
        bonus: 1,
        probability: 0.5,
        quantity: [1, 1],
        condition: 'chapter>=3',
      ...
      },
      {
        name: '强效治疗药水',
        type: 'potion',
        description: '浓缩的治疗精华，散发着金色微光。饮用后恢复4d4+4生命值。',
        bonus: 4,
        probability: 0.4,
        quantity: [1, 1],
        condition: 'chapter>=3',
  ...
  // ── 碎石荒原 ──────────────────────────────────
  {
    ...
    items: [
      ...
      { name: '古代文书残页', type: 'quest', description: '墓冢中的文书残页，记载了虚空棱镜被封印的经过。', probability: 0.65, quantity: [1, 1], condition: 'chapter>=4', oneTime: true },
      {
        name: '雷击粉',
        type: 'misc',
        description: '雷石研磨的粉末，附着于武器表面。武器附加雷电伤害类型。',
        probability: 0.20,
        quantity: [1, 2],
        condition: 'chapter>=4',
        oneTime: false,
  ...
  // ── 灰脊矿道下层（深渊祭坛） ─────────────────
  {
    ...
    items: [
      ...
      { name: '破晓战锤', type: 'weapon', description: '古代晨光骑士的遗物，锤头刻有驱散黑暗的符文。造成1d10+2钝击伤害。', bonus: 2, probability: 0.6, quantity: [1, 1], condition: 'chapter>=4', oneTime: true },
      { name: '晨光护胸甲', type: 'armor', description: '镌刻晨光纹路的胸甲，残存着远古的守护力量。AC+3。', bonus: 3, probability: 0.5, quantity: [1, 1], condition: 'chapter>=4', oneTime: true },
      { name: '强效治疗药水', type: 'potion', description: '浓缩的治疗精华，金色微光。恢复4d4+4HP。', bonus: 4, probability: 0.5, quantity: [1, 2], condition: 'chapter>=4' },
      ...
      },
      {
        name: '防火药膏',
        type: 'potion',
        description: '防护药膏，一场战斗内对火焰伤害有抗性。',
        probability: 0.25,
        quantity: [1, 1],
        condition: 'chapter>=4',
        oneTime: false,
